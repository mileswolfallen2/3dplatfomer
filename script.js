...
const createScene = function () {
    ...
    const camera = new BABYLON.ArcRotateCamera(
        ...
        50, // Distance from the center of the world
        BABYLON.Vector3.Zero(), // Target the center of the world
        scene
    );
    ...
    engine.runRenderLoop(function () {
        ...
        if (player.intersectsMesh(scene.meshes.find(mesh => mesh.name === "ground"), false)) {
